...
function draw_bar (x1, y1, w1, h1, barColor, emptyBarColor,  borderColor, borderThickness, total, outOfTotal, isvertical) {
	...
	if isvertical {
		...
		draw_set_color(emptyBarColor);
		draw_rectangle(x1 + borderThickness, y1 + borderThickness, x1 + w1 - borderThickness, y1 + h1 - borderThickness, false);
