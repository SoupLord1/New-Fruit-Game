...
if distance_to_object(Player) < nearestEnemy.allowedDisToPlayer and path_get_length(nearestEnemy.path) < 400 and path_get_length(nearestEnemy.path) > 64 and canFire and global.arrows > 0{
	visible = 1;
